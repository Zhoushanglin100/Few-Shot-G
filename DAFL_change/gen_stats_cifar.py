...
parser.add_argument('--end_class', type=int, default=10, 
                    help='number of division of dataset')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.dataset == 'cifar10':
        train_loader, val_loader = get_split_cifar10(args, args.batch_size, 
                                                                args.start_class, args.end_class)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # ### check
        # temp = torch.load("stats/mean_resnet34_output.pth")
        # for i in temp:
        ...
        torch.save(mean_layers_dictionary, "stats/mean_"+args.arch+"_"+args.hook_type+".pth")
        torch.save(var_layers_dictionary, "stats/var_"+args.arch+"_"+args.hook_type+".pth")

        # for i in mean_layers_dictionary:
        #     print(i, mean_layers_dictionary[i].shape)
