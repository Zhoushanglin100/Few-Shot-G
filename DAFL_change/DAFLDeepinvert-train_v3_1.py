...
parser.add_argument('--dataset', type=str, default='cigar0', choices=['MNIST','cifar10','cifar100'])
...
parser.add_argument('--lr_S', type=float, default=0.06, help='learning rate')
...
def adjust_learning_rate(optimizer, epoch):
    ...
    """ 
    if epoch < 50: # only train G
        lr = 0
    elif epoch < 75: # warn up
        lr = 0.06 * (epoch-50)/ 25
    else:
        lr = 0.06 # lr decay
        lr_sq = ((epoch-50 )// 25)+1
