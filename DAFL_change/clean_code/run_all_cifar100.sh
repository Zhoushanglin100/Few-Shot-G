...
# bash run_hpc.sh $partion s3 $fewS resnet34 resnet $G_bz $S_bz $lambda $latent_dim 0.1 0.01 $ratio $imagenet_path &
# bash run_hpc.sh $partion s3 $fewS vgg16 vgg $G_bz $S_bz $lambda $latent_dim 0.1 0.01 $ratio $imagenet_path &
# bash run_hpc.sh $partion s3 $fewS vgg16 resnet $G_bz $S_bz $lambda $latent_dim 0.1 0.01 $ratio $imagenet_path &
