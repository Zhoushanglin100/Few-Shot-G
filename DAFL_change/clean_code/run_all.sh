...
#     do
#         bash run_local.sh $partion s1 $sample_bz $teacher resnet 128 128 10 1000 0.1 0.01 0.5 $imagenet_path &
#     done
# done
...
# bash run_local.sh $partion s3 10 resnet34 resnet $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
# bash run_local.sh $partion s3 50 resnet34 resnet $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
# bash run_local.sh $partion s3 100 resnet34 resnet $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path

# bash run_local.sh $partion s3 10 vgg16 vgg $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
# bash run_local.sh $partion s3 50 vgg16 vgg $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
# bash run_local.sh $partion s3 100 vgg16 vgg $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path

# bash run_local.sh $partion s3 10 vgg16 resnet $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
# bash run_local.sh $partion s3 50 vgg16 resnet $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
# bash run_local.sh $partion s3 100 vgg16 resnet $G_bz $S_bz 10 $latent_dim 0.1 0.01 $ratio $imagenet_path
