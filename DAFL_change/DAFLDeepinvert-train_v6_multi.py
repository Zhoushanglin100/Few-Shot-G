...
def train(args, net, generator, teacher, 
            epoch, optimizer_S, optimizer_G, criterion, 
...
def test(args, net, data_test_loader, criterion, acc_best):
...
def train_and_test(args, net, generator, teacher, epoch, 
                    data_train_loader, data_test_loader,
                    optimizer_S, optimizer_G, criterion, 
                    loss_r_feature_layers, lim_0, lim_1,
                    acc_best, save_path):

    train(args, net, generator, teacher, 
            epoch, optimizer_S, optimizer_G, criterion, 
            loss_r_feature_layers, lim_0, lim_1, 
            save_path)
    test(args, net, data_test_loader, criterion, acc_best)

#############################################################

def main(args, start_class, end_class):
    ...
    if args.dataset == 'cifar10':
        ...
        data_train_loader, data_test_loader = get_split_cifar100(args.batch_size, start_class, end_class)
    ...
    for e in range(start_epoch, epoch):
        ...
        train_and_test(args, net, generator, teacher, e, 
                        data_train_loader, data_test_loader,
                        optimizer_S, optimizer_G, criterion, 
                        loss_r_feature_layers, lim_0, lim_1,
                        acc_best, save_path)
