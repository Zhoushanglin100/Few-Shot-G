...
def main_worker(gpu, ngpus_per_node, args):
    ...
    ### cifar10
        ...
        trainset = datasets.CIFAR10(root='./cache/data', train=True, download=True, transform=transform_train)
        train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True, num_workers=2)

        testset = datasets.CIFAR10(root='./cache/data', train=False, download=True, transform=transform_test)
    ...
    ### cifar100
        ...
        trainset = datasets.CIFAR100('./cache/data', train=True, download=True, transform=transform_train)
        testset = datasets.CIFAR100('./cache/data', train=False, download=True, transform=transform_test)
...
def train(train_loader, model, criterion, optimizer, epoch, args):
    ...
    for i, (images, target) in enumerate(train_loader):
        ...
        # temp = torch.load("stats/stats_cifar10_vgg16/stats_single_sample_splz128/output/mean_vgg16_start-0_end-1.pth")
        # for i in temp:
        ...
        torch.save(mean_layers_dictionary, save_path+"/mean_"+args.arch+"_"+"start-0_end-1.pth")
        torch.save(var_layers_dictionary, save_path+"/var_"+args.arch+"_"+"start-0_end-1.pth")
