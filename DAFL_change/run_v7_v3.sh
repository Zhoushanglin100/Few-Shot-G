...
# #
bash run_cifar100_v5.sh output 16 128 10 3000 $1 128 s2 &
bash run_cifar100_v5.sh output 16 128 100 3000 $1 128 s2 &

bash run_cifar100_v5.sh input 16 128 10 3000 $1 128 s2 &
bash run_cifar100_v5.sh input 16 128 100 3000 $1 128 s2 &