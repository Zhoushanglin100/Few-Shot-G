...
if has_wandb:
    id = "lr_bz{}-{}-ld{}-eN{}-eG{}-lrG{}-lrS{}-dcy{}".format(args.batch_size, args.fix_G, args.latent_dim,
...
def train(epoch, args):
    if args.dataset != 'MNIST':
        scheduler = CosineAnnealingWarmRestarts(optimizer_S, 5, 1)
    ...
    for i in range(200): # 256 batch size * 200: 51200 images
        ...
        if epoch > args.n_epochs_G:
            ...
            if has_wandb:
                wandb.log({"lr/lr_S": scheduler.get_lr()})
